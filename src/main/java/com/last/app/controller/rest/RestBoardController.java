...
public class RestBoardController {
	...
	public List<Board> getList() {
		...
		//결과를 jsp보여주는 것이 아니라, 외부의 시스템에서 중립적인 형태의
		//데이터 제공을 원하므로, json or xml 형태로 제공해준다.
		//이때, json문자열 처리를 개발자가 일일이 하지 않고 Spring 프레임웍이
		//자동으로 변환(Convert) 해 주는 기능이 있다.
		//@ResponseBody 이용하면 자동으로 json,xml 등 포맷으로 변환해줌 
